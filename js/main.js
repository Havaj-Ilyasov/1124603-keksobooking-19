...
var renderPin = function (data, index) {
  ...
  pin.querySelector('img').alt = data[index].offer.title;
  pin.style.left = data[index].location.x + 'px';
  pin.style.top = data[index].location.y + 'px';
  return pin;
};
...
var renderPopup = function (data, index) {
  ...
  popupElement.querySelector('.popup__title').textContent = data[index].offer.title;
  popupElement.querySelector('.popup__text--address').textContent = data[index].offer.address;
  popupElement.querySelector('.popup__text--price').textContent = data[index].offer.price;
  popupElement.querySelector('.popup__type').textContent = data[index].offer.type;
